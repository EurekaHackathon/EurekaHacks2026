...
const TEAM: TeamMember[] = [
  ...
  },
  {
    name: "Peony Zuo",
    role: "Marketing Girl",
    description: "Yep! I'll talk to you face to face when I'm not faceplanting",
    image: "/team/Peony.png",
    superpower: "I can eat an entire bag of sour patch kids in 5 minutes",
    supercolor: "#2f00ffff",
  },
  {
    name: "Minsun Kim",
  ...
  },
  {
    ...
    role: "I Got It Guy",
    description: "Testing and console logs are for cowards, just force push.",
    image: "/team/DanielXu.png",
    superpower: "Crashing prod",
    supercolor: "#61008eff",
  },
  {
    name: "Tiger Sun",
        ...
        >
          ...
          {member.superpower && (
            <p
              style={{
                fontFamily: "var(--font-righteous)",
                fontSize: targetSpec.descSize
                  ? Math.max(targetSpec.descSize - 4, 6)
                  : 18,
                ...
                margin: 0,
                transition:
                  "font-size 0.8s ease, opacity 0.8s ease, color 0.8s ease",
              }}
            >
              <span style={{ color: "#284062" }}>SUPERPOWER:</span>{" "}
              {member.superpower}
            </p>
          )}
        </div>
        ...
        >
          <h2
            style={{
              ...
              paddingLeft: isMobile ? slots[0]?.x || 20 : 0,
            }}
          >
            Meet the team
          </h2>
          ...
          <div
            style={{
              position: "relative",
              height: isMobile ? 420 : slots[0]?.h ? slots[0].h + 10 : 430,
              width: "100%",
          ...
          >
            ...
            {[...Array(7)].map((_, i) => {
              ...
              const member =
                TEAM[((cardIndex % TEAM.length) + TEAM.length) % TEAM.length];
