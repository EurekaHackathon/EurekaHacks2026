...
function SponsorCard({
  ...
  const returnClass =
    "w-full h-full flex items-center justify-center p-2 transition-transform duration-200 hover:scale-105 " +
    tier;

  return (
    <div className={`flex items-center justify-center noborder ${tierCol}`}>
    ...
    <section className="flex justify-center items-center py-12 px-4">
      <div className="border-12 border-white shadow-2xl max-w-6xl w-full p-6">
        <div className="py-4 px-32">
          <h2 className="text-8xl font-righteous text-white text-center tracking-wide mb-2 margining">
            SPONSORS
          </h2>
