...
export default function AboutSection() {
  return (
    <div className="flex justify-center items-center px-12 w-screen py-4" id="about">
      <div className="max-w-7xl flex flex-col sm:flex-row border-12 border-white relative bg-[#0a1c29] md:!pr-8">
