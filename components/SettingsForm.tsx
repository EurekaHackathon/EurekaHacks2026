    ...
    return (
        <div className="text-gray-700 w-full">
            ...
            <form className="mt-8">
                ...
                <button type="submit"
                        className="bg-secondary-50 text-secondary-900 font-medium py-2 px-4 rounded-lg mt-8 hover:bg-secondary-200 duration-200">Save
                    changes
                </button>
            </form>
            ...
            {loginMethod === "email" &&
                <>
                  ...
                  <form className="mt-8">
                    ...
                    <button type="submit"
                            className="bg-secondary-50 text-secondary-900 font-medium py-2 px-4 rounded-lg mt-8 hover:bg-secondary-200 duration-200">Change
                      password
                    </button>
                  </form>
                </>
