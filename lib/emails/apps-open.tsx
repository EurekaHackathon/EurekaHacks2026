...
export const ApplicationsOpenTemplate = ({
    ...
    <Email previewText="Apply now on the hacker dashboard! 🚀">
        ...
        <Paragraph>
            ...
            Join us from May 1st-2nd at the Waterloo Accelerator Centre for two unforgettable days of
            innovation, learning, and fun.
        </Paragraph>
        <HighlightSection>
            📍 Location: Waterloo Accelerator Centre (295 Hagey Blvd, Waterloo)<br/>
